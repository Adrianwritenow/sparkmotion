...
import { getTimezoneForLocation } from "../../utils/us-timezones";
...
interface EventFormProps {
  ...
  /** Admin: pass orgs array to render org selector */
  orgs?: Array<{ id: string; name: string }>;
}

export function EventForm({ onSubmit, isPending, campaigns, defaultCampaignId, orgs }: EventFormProps) {
