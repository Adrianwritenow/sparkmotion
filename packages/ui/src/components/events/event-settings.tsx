...
interface EventSettingsProps {
  ...
  /** Admin passes the "Clean Up Analytics" section here */
  extraSections?: React.ReactNode;
}

export function EventSettings({ event, extraSections }: EventSettingsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Admin-only sections slot (e.g. Clean Up Analytics) */}
      {extraSections}
