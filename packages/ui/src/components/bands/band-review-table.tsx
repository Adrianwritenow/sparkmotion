...
interface BandReviewTableProps {
  /** Admin: pass orgs list to show org filter dropdown */
...
export function BandReviewTable({ orgs }: BandReviewTableProps = {}) {
  ...
  const filterDeps = [debouncedSearch, orgId, flaggedOnly, timePreset, tagId];
  ...
  const resolvedOrgId = orgId && orgId !== "all" ? orgId : undefined;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <BandTrashButton orgId={resolvedOrgId} showDeletedBy={!!orgs} />
      </div>
