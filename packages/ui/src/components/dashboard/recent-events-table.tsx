...
interface RecentEventsTableProps {
  ...
  /** Admin: show the Organization column. Defaults to false. */
...
export function RecentEventsTable({ events, showOrgColumn = false }: RecentEventsTableProps) {
  return (
