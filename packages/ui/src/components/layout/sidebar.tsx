...
import { LogOut, Monitor, Moon, PanelLeft, PanelRight, Sun, User } from "lucide-react";
import React, { createElement, useEffect, useState } from "react";
import { usePathname, useRouter } from "next/navigation";

import Link from "next/link";
import { SmLogotype } from "../sm-logotype";
...
export function Sidebar({ navItems, isMobile = false, user, onSignOut }: SidebarProps) {
...
function NavItemLink({ href, icon: Icon, label, active, collapsed, isMobile = false, showAlert }: NavItemLinkProps) {
  return (
    <Link
      href={href}
